 ...
 */
public class ResultProperties extends Result<RdfResourceDefinitionDTO> {
    /**
     * Constructor which calls the mother-class constructor in the case of a
     * list with only 1 element
     * @param properties 
     */
    public ResultProperties(ArrayList<RdfResourceDefinitionDTO> properties) {
        super(properties);
    }
     ...
     * @param paginate 
     */
    public ResultProperties(ArrayList<RdfResourceDefinitionDTO> properties, Pagination pagination, boolean paginate) {
