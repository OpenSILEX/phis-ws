...
public class PropertyDAOSesame extends DAOSesame<Property> {
     ...
     * @return the list of the properties which match the given uri.
     */
    public ArrayList<RdfResourceDefinitionDTO> getAllPropertiesWithLabels(String language) {     
            ...
            try (TupleQueryResult result = tupleQuery.evaluate()) {
                while (result.hasNext()) {
                    ...
                    if (properties.hasProperty(property)) {
                        ...
                        PropertyLabelsDTO existingProperty = (PropertyLabelsDTO)properties.getProperty(property);
